...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_tok_number_literal = 5,         /* tok_number_literal  */
  YYSYMBOL_tok_string_literal = 6,         /* tok_string_literal  */
  YYSYMBOL_tok_assignment_operator_l = 7,  /* tok_assignment_operator_l  */
  YYSYMBOL_tok_assignment_operator_r = 8,  /* tok_assignment_operator_r  */
  YYSYMBOL_tok_mult = 9,                   /* tok_mult  */
  YYSYMBOL_tok_div = 10,                   /* tok_div  */
  YYSYMBOL_tok_mod = 11,                   /* tok_mod  */
  YYSYMBOL_tok_plus = 12,                  /* tok_plus  */
  YYSYMBOL_tok_minus = 13,                 /* tok_minus  */
  YYSYMBOL_tok_yes = 14,                   /* tok_yes  */
  YYSYMBOL_tok_no = 15,                    /* tok_no  */
  YYSYMBOL_tok_gt = 16,                    /* tok_gt  */
  YYSYMBOL_tok_gt_o_eq = 17,               /* tok_gt_o_eq  */
  YYSYMBOL_tok_lt = 18,                    /* tok_lt  */
  YYSYMBOL_tok_lt_o_eq = 19,               /* tok_lt_o_eq  */
...
static const char *const yytname[] =
{
  ...
  "tok_identifier", "tok_number_literal", "tok_string_literal",
